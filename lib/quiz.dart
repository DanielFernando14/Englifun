...
import 'package:englifun/aktivitas quiz.dart';
import 'package:englifun/alatdapur quiz.dart';
import 'package:englifun/alatmusik quiz.dart';
import 'package:englifun/alatrumah quiz.dart';
import 'package:englifun/alatsekolah quiz.dart';
import 'package:englifun/anggotatubuh quiz.dart';
import 'package:englifun/angka quiz.dart';
import 'package:englifun/bentuk quiz.dart';
import 'package:englifun/buah quiz.dart';
import 'package:englifun/hewan quiz.dart';
import 'package:englifun/hobby quiz.dart';
import 'package:englifun/keluarga quiz.dart';
import 'package:englifun/makanan quiz.dart';
import 'package:englifun/minuman quiz.dart';
import 'package:englifun/musim quiz.dart';
import 'package:englifun/olahraga quiz.dart';
import 'package:englifun/pakaian quiz.dart';
import 'package:englifun/profesi quiz.dart';
import 'package:englifun/ruangandirumah quiz.dart';
import 'package:englifun/sayuran quiz.dart';
import 'package:englifun/tempat quiz.dart';
import 'package:englifun/transportasi quiz.dart';
import 'package:englifun/warna quiz.dart';
import 'package:englifun/abjad%20quiz.dart';
                          ...
                          switch (itemIndex) {
                            ...
                            case 6:
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const AnggotaTubuhQuiz(),
                                ),
                              );
                              break;
                            case 7:
                            ...
                            case 19:
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const RuanganDiRumahQuiz(),
                                ),
                              );
                              break;
                            case 20:
                            ...
                            case 22:
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const TransportasiQuiz(),
                                ),
                              );
                              break;
                            case 23:
